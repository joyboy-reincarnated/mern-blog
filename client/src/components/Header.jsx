  ...
  return (
    <Navbar className='border-b-2'>
        <Link className='self-center whitespace-nowrap text-sm sm:text-xl font-semibold dark:text-white' to={'/'}  >
            <span className='px-2 py-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg text-white'>Vijay's</span>
            Blog
        </Link>
        <form > 
            <TextInput
            ...
            </Button>
            {
                currentUser ? ( 
                    ...
                    >
                        <Dropdown.Header>
                            <span className='blo
                            text-sm '>@{currentUser.username}</span>
                            <span className='blo
